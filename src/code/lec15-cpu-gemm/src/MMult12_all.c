                                    ...
                                    double *c, int ldc)
{
  ...
  double __attribute__((aligned(64))) packedB[kc * 1300];
...
{
  __m512d c_00 = _mm512_load_pd(&C( 0*8, 0 ));  //C(0:7,0) _mm512_set1_pd(0);//
  __m512d c_01 = _mm512_load_pd(&C( 0*8, 1 ));  //C(0:7,1) _mm512_set1_pd(0);//
  __m512d c_02 = _mm512_load_pd(&C( 0*8, 2 ));  //C(0:7,2) _mm512_set1_pd(0);//
  __m512d c_03 = _mm512_load_pd(&C( 0*8, 3 ));  //C(0:7,3) _mm512_set1_pd(0);//
  __m512d c_04 = _mm512_load_pd(&C( 0*8, 4 ));  //C(0:7,4) _mm512_set1_pd(0);//
  __m512d c_05 = _mm512_load_pd(&C( 0*8, 5 ));  //C(0:7,5) _mm512_set1_pd(0);//
  __m512d c_06 = _mm512_load_pd(&C( 0*8, 6 ));  //C(0:7,6) _mm512_set1_pd(0);//
  __m512d c_07 = _mm512_load_pd(&C( 0*8, 7 ));  //C(0:7,7) _mm512_set1_pd(0);//
  __m512d c_10 = _mm512_load_pd(&C( 1*8, 0 ));  //C(8:15,0)_mm512_set1_pd(0);//
  __m512d c_11 = _mm512_load_pd(&C( 1*8, 1 ));  //C(8:15,1)_mm512_set1_pd(0);//
  __m512d c_12 = _mm512_load_pd(&C( 1*8, 2 ));  //C(8:15,2)_mm512_set1_pd(0);//
  __m512d c_13 = _mm512_load_pd(&C( 1*8, 3 ));  //C(8:15,3)_mm512_set1_pd(0);//
  __m512d c_14 = _mm512_load_pd(&C( 1*8, 4 ));  //C(8:15,4)_mm512_set1_pd(0);//
  __m512d c_15 = _mm512_load_pd(&C( 1*8, 5 ));  //C(8:15,5)_mm512_set1_pd(0);//
  __m512d c_16 = _mm512_load_pd(&C( 1*8, 6 ));  //C(8:15,6)_mm512_set1_pd(0);//
  __m512d c_17 = _mm512_load_pd(&C( 1*8, 7 ));  //C(8:15,7)_mm512_set1_pd(0);//
  __m512d c_20 = _mm512_load_pd(&C( 2*8, 0 ));  //C(16:23,0_mm512_set1_pd(0);//)
  __m512d c_21 = _mm512_load_pd(&C( 2*8, 1 ));  //C(16:23,1_mm512_set1_pd(0);//)
  __m512d c_22 = _mm512_load_pd(&C( 2*8, 2 ));  //C(16:23,2_mm512_set1_pd(0);//)
  __m512d c_23 = _mm512_load_pd(&C( 2*8, 3 ));  //C(16:23,3_mm512_set1_pd(0);//)
  __m512d c_24 = _mm512_load_pd(&C( 2*8, 4 ));  //C(16:23,4_mm512_set1_pd(0);//)
  __m512d c_25 = _mm512_load_pd(&C( 2*8, 5 ));  //C(16:23,5_mm512_set1_pd(0);//)
  __m512d c_26 = _mm512_load_pd(&C( 2*8, 6 ));  //C(16:23,6_mm512_set1_pd(0);//)
  __m512d c_27 = _mm512_load_pd(&C( 2*8, 7 ));  //C(16:23,7_mm512_set1_pd(0);//)
  __m512d b_0, b_1;
